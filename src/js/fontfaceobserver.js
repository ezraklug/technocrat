...
;(function() {
  ...
  //var fontHeadLight   = new FontFaceObserver('Catamaran', { weight: 300 });
  var fontHeadNormal  = new FontFaceObserver('Catamaran', { weight: 300 });
  var fontHeadBold    = new FontFaceObserver('Catamaran', { weight: 500 });
  var fontBodyLight   = new FontFaceObserver('Oxygen', { weight: 300 });
  var fontBodyNormal  = new FontFaceObserver('Oxygen', { weight: 400 });
  var fontBodyBold    = new FontFaceObserver('Oxygen', { weight: 600 });
